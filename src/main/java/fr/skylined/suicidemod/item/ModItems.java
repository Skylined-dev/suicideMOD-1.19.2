...
public class ModItems {
    ...
    public static final RegistryObject<Item> NETHERSTAR_FRAGMENT_UP_FOIL = ITEMS.register("netherstar_fragment_up_foil", () -> new EnchantedItem(new Item.Properties().tab(ModCreativeModeTab.SUICIDEMOD_TAB)));
    public static final RegistryObject<Item> NETHERSTAR_FRAGMENT_DOWN_FOIL = ITEMS.register("netherstar_fragment_down_foil", () -> new EnchantedItem(new Item.Properties().tab(ModCreativeModeTab.SUICIDEMOD_TAB)));
    public static final RegistryObject<Item> NETHERSTAR_FRAGMENT_LEFT_FOIL = ITEMS.register("netherstar_fragment_left_foil", () -> new EnchantedItem(new Item.Properties().tab(ModCreativeModeTab.SUICIDEMOD_TAB)));
    public static final RegistryObject<Item> NETHERSTAR_FRAGMENT_RIGHT_FOIL = ITEMS.register("netherstar_fragment_right_foil", () -> new EnchantedItem(new Item.Properties().tab(ModCreativeModeTab.SUICIDEMOD_TAB)));
